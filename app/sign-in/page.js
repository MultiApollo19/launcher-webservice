        ...
        <main >
            <div className="flex justify-center flex-col place-items-center">
                ...
                <form method="post" onSubmit={handleSubmit} className='flex flex-col mt-8 appearance-none'>
                    ...
                    <input type='password' id='password' name='password' required className=' bg-[#242B48] rounded flex focus:outline-none text-whit focus:ring-[#1f80db] focus:ring focus:border-[#1f80db] focus:bg-[#3D4874]' />
